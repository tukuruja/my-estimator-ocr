...
import { createConsensusApiMiddleware } from "./server/consensusApi";
...
function vitePluginProjectStateApi(): Plugin {
  return {
    name: "project-state-api",
    configureServer(server) {
      server.middlewares.use(createConsensusApiMiddleware());
